...
are about configuring Neovim for navigating through Python sources. These have
been tested on Debian 12. I could have explored Vim but thought of trying
something else so that the existing editor settings did not get disturbed.
Another reason for choosing Neovim was that it had an built-in Language Server
Protocol (LSP) client.
...
This installed Pyright 1.1.408. Install Neovim:

----
$ sudo apt-get install neovim
----

This installed Neovim 0.7.2. Install plugin for Neovim LSP client
configuration:
