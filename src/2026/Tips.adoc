...
These are a collection of mainly software usage tips that I have noted
down over several years. My working environment is mostly Ubuntu 22.04 or
Oracle Linux 9. Earlier, it used to be CentOS 7.
